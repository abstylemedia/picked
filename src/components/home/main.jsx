...
const Main = () => {
  return (
    <div>
      <div className="flex bg-no-repeat bg-cover ">
        <img src="/ank.webp" alt="detail" className="w-full lg:h-full  " />
      </div>
      <div className="basis-full lg:bg-slate-500 lg:h-96 md:h-80 h-64 ">
        <div className="flex items-center justify-center content-center">
          <img
            src="/s.gif"
            alt="detail"
            className="lg:mt-11 md:mt-16 sm:mt-16 mt-8 lg:max-h-[400px] md:max-h-[330px] sm:max-h-[330px]"
          />
        </div>
      </div>
      <div className="lg:mt-20 md:mt-16 sm:mt-1">
        <div className="p-4">
         
          <body className="bg-slate-500 text-gray-100 px-8 py-11">
            <div className="max-w-screen-xl mt-8 px-8 grid gap-8 grid-cols-1 md:grid-cols-1 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                    ...
                    <div className=" items-center mt-12 ">
                      <form>
                        <input
                          ...
                          type="radio"
                          name="order"
                          className="w-6 h-5 bg-gray-100 border-gray-300 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
                        />
                        <label className="ml-2 text-xl font-medium text-gray-900 dark:text-gray-300">
                          Email
                        </label>
                        ...
                        <input
                          ...
                          type="radio"
                          name="order"
                          className="w-6 h-5 ml-3 bg-gray-100 border-gray-300 dark:ring-offset-gray-800  dark:bg-gray-700 dark:border-gray-600"
                        />
                        <label className="ml-2 text-xl font-medium text-gray-900 dark:text-gray-300">
                          Phone
                        </label>
                      </form>
                      <div className="mt-3 lg:px-56  mb-5">
                        <form>
                          <div className="flex">
