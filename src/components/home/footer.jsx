...
<section className="relative z-10  bg-white py-20 ">
  <div className="container ">
    <div className=" flex flex-wrap ">
      <div className="w-full px-5 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 ">
          ...
          We are an everything on-demand delivery app, making it simple to picked and deliver from the palm of your hand.From grocery to home furnishings and everything in between, we got you covered. Now go enjoy that glass of wine!
          </p>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">
                99 S.t Jomblo Park 141001. India
              </p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">(+91)9907790004</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">abstylemedia@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form>
            ...
            <div>
              <button
                type="submit"
                className="bg-primary border-primary w-full rounded border p-3 text-black transition hover:bg-slate-600"
              >
                Send Message
              </button>
            </div>
  ...
  <div className="text-center mt-7 p-6">
                <h1 className="text-base text-black-300 font-medium">© 2022 AB Style Media. All Rights Reserved</h1>
             </div>
</section>
