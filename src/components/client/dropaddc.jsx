...
export default class DropaddCommerical extends Component {
    componentDidMount(){
                ...
                <div className="px-3 pt-5">
                    <div className=" rounded-md bg-white py-5 px-5">
                        ...
                        <div className="border mt-2 rounded-2xl flex">
                            ...
                            className="basis-1/2 focus:bg-black rounded-2xl focus:text-white py-1" >
                                Residential
                            </button>
                            <button value="Commerical" onClick={() =>window.location.href = "/dropaddc"}
                            className="basis-1/2 bg-black rounded-2xl text-white py-1" >
                                Commerical
                            </button>
                        </div>
                        <form className="mt-4">
