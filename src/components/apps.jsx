    ...
    return(
        <div className="">
            <div className="h-auto" style={myStyle}>
                ...
                <div className=" ">
                <ul class="list-none p-5 grid grid-cols-1 lg:grid-cols-4 gap-4  justify-between ">
                    <li className="mt-2">
                    ...
                    <div className="text-center my-3">
                        <div class="text-lg font-medium text-black">Download The App</div>
                    ...
                    <div className="text-center my-3">
                        <div class="text-base font-medium text-black">Order Online From Any Retailer, Marketplace or Store</div>
                    ...
                    <div className="text-center my-3">
                        <div class="text-base font-medium text-black">Place A Pickup Request Through Our App
</div>
                    ...
                    <div className="text-center my-3">
                        <div class="text-base font-medium text-black">Track Your Order</div>
